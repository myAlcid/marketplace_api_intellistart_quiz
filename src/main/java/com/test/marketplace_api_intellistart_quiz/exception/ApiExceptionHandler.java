package com.test.marketplace_api_intellistart_quiz.exception;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNotEnoughMoneyException(NotEnoughMoneyException ex) {

        ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST);
        apiError.setMessage("User dont have enough amount of money");
        apiError.setErrors(Arrays.asList(ex.getMessage()));
        return new ResponseEntity(apiError, apiError.getStatus());
    }
